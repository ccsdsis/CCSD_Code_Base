...
<%
// AthleticSectionRostersBySeason-SCRODJ0001.jsp
// 2018-06-26 (fm) SIS-6160 Added variables to the sql for testing. Enhanced report description for front-end users.
//                          Renamed jsp from AthleticSectionRostersBySeason-SCRODR0001.jsp to AthleticSectionRostersBySeason-SCRODJ0001.jsp
//
...
// baseURL
	...
	String srsReportName = "AthleticSectionRostersBySeason-SCRODR0001";
	String jspPageName = "AthleticSectionRostersBySeason-SCRODJ0001";	
%>
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px; padding-left: 30px">ATHLETIC SECTION ROSTERS BY SEASON</TD>
		</TR>
		...
		<TD class="style2" 
		    ...
		    This report produces a roster of each sports team and section staff for the current school/calendar and selected season(s).&nbsp; Roster data is pulled from the Athletics sections.</br><br>A school must be selected in the Infinite Campus toolbar. </TD>
		</TR>
