...
<%
// AthleticSectionRostersBySport-SCRODJ0003.jsp
// 2018-06-26 (fm) SIS-6162 Enhanced report description for front-end users. Added modification history to sql.
//                          Renamed jsp from AthleticSectionRostersBySport-SCRODR0003.jsp to AthleticSectionRostersBySport-SCRODJ0003.jsp
...
// baseURL
	...
	String jspPageName = "AthleticSectionRostersBySport-SCRODJ0003";	
%>
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px; padding-left: 30px">ATHLETIC SECTION ROSTERS BY SPORT</TD>
		</TR>
		...
		<TD class="style2" 
		    ...
		    This report produces a roster and section staff for the current school/calendar and selected sport.  Roster data is pulled from the Athletics sections.</br><br>A school must be selected in the Infinite Campus toolbar. 
		</TR>
 ...
 <%
		    ...
		    SQL1 = "  select distinct number, name " + 
                   " from coursemaster where substring(number, 1,3) = 'ATH' " + 
                   " order by name ";
