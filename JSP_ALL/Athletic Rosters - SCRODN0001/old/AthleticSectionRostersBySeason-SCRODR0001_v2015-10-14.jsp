...
// baseURL
	...
	String jspPageName = "AthleticSectionRostersBySeason-SCRODR0001";	
%>
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">ATHLETIC SECTION ROSTERS BY SEASON</TD>
		</TR>
		...
		<TD class="style2" 
            ...
            the current school/calendar.&nbsp; Roster data is pulled from the Athletics 
            sections.</br></TD>
		</TR>
