...
<%
// AthleticTeamRostersBySeason-SCRODJ0002.jsp
// 2018-06-26 (fm) SIS-6159 Renamed Report to Athletic Team Rosters By Season. Added jsp variables to the sql for testing. Corrected report name in the jsp.
//                          Renamed jsp from AthleticTeamRostersBySeason-SCRODR0002.jsp to AthleticTeamRostersBySeason-SCRODJ0002.jsp
//
...
// baseURL
	...
	String Season1Select = request.getParameter("Season1");
	String Season2Select = request.getParameter("Season2");
	String Season3Select = request.getParameter("Season3");
	
	//variables needed for page to know itself and call the right report
	String dir = "AthleticRosters-SCRODN0001/";
	String srsReportName = "AthleticTeamRostersBySeason-SCRODR0002";
	String jspPageName = "AthleticTeamRostersBySeason-SCRODJ0002";	
%>
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&calendarID="+calendarID+"&Season="+Season1Select+"&Season="+Season2Select+"&Season="+Season3Select;
		url += "&rs%3AFormat=PDF";
...
<% con.close(); %>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px; padding-left: 30px">ATHLETIC TEAM ROSTERS BY SEASON</TD>
		</TR>
		...
		<TD class="style2" 
		    ...
		    This report produces a roster of each sports team for the current school/calendar and selected season(s).&nbsp; Roster data is pulled from the Athletics sections.</br><br>A school must be selected in the Infinite Campus toolbar. </TD>
		</TR>
	...
	<table class="style1">
        <tr>
            ...
            <td>
				...
				<input id="Season1" name="Season1" type="checkbox" value="Fall" />FALL<br />
                <input id="Season2" name="Season2" type="checkbox" value="Winter" />WINTER<br />
                <input id="Season3" name="Season3" type="checkbox" value="Spring" />SPRING</td>
        </tr>
        <tr>
            <td valign="top">&nbsp;
                </td>
