...
// baseURL
	...
	String srsReportName = "NIAA-Eligibility-SIREDR0014";
	String jspPageName = "NIAA-Eligibility-SIREDR0014";	
%>
...
<% con.close(); %>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">NIAA ELIGIBILITY ROSTER</TD>
		</TR>
		...
		<TD class="style2" 
		    ...
		    This report produces a roster of each sports team for the selected season(s) and 
            the current school/calendar for NIAA Eligibilty.  Report displays parent/guardian data if the student has a guardian selected in the household.  The report only displays the first parent/gaurdian listed in the household.</br></TD>
		</TR>
