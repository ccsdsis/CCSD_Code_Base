...
<%
// SIS-5873 2018-04-03 (FM) Include behavior admins with future end date in dropdown list
// SIS-2517 2016-09-02 (FM) Removed parms @tempEffDt and @tempBox. RENAMED JSP TO "NoticeOfRPC-BEREDJ0004".
...
// baseURL
	...
	String srsReportName = "NoticeOfRPC-BEREDR0004";
	String jspPageName = "NoticeOfRPC-BEREDJ0004";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;&nbsp;Notice of Required Parent Conference&nbsp;&nbsp;CCF-805</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Print a Notice of Required Parent Conference for the selected student and behavior event.<br/>
		  </p>
