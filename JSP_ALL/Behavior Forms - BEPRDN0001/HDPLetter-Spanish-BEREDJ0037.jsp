...
// SIS-3815 2017-02-17 (FM) NEW HDP Letter - Spanish. Pulls resolution code "SUS". 
//
...
// baseURL
	...
	String srsReportName = "HDPLetter-Spanish-BEREDR0037";
	String jspPageName = "HDPLetter-Spanish-BEREDJ0037";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&personID="+contextID+"&calendarID="+calendarID+"&adminPersonID="+adminPersonIDValue;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;&nbsp;Habitual Discipline Problem (HDP) Letter (Spanish)</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Print a Habitual Discipline Problem (HDP) letter in Spanish for the selected student and behavior administrator.<br/>
		  </p>
		  <p><span style="color:red"><strong>* Letter requires a Behavior Event with a 'Suspension' (SUS) resolution.</strong></span><BR/>
		    <BR/>
	      </p>
		</TD>
		</TR>
