...
// baseURL
	...
	String srsReportName = "NoticeOfTruancy-Spanish-BEREDR0008";
	String jspPageName = "NoticeOfTruancy-Spanish-BEREDR0008";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;&nbsp;Notice of Truancy (Spanish)</TD>
		</TR>
		...
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;font-size: 10px; font-weight: bold;" valign="top">
		  <span style="font-size: 8pt">Print a Notice of Truancy in Spanish for the selected student.</span>
		  <p></TD>
		</TR>
