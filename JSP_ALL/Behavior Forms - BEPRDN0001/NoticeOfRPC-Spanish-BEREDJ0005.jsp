...
<%
// SIS-5872 2018-04-03 (FM) Include behavior admins with future end date in dropdown list
// SIS-2517 2016-09-02 (FM) Removed parms @tempEffDt and @tempBox. RENAMED JSP TO "NoticeOfRPC-Spanish-BEREDJ0005"
...
// baseURL
	...
	String srsReportName = "NoticeOfRPC-Spanish-BEREDR0005";
	String jspPageName = "NoticeOfRPC-Spanish-BEREDJ0005";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&personID="+contextID+"&calendarID="+calendarID+"&incidentID="+incidentIDValue+"&adminPersonID="+adminPersonIDValue;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;&nbsp;Notice of Required Parent Conference (Spanish)&nbsp;&nbsp;CCF-805</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Print a Notice of Required Parent Conference in Spanish for the selected student and behavior event.<br/>
		  </p>
		  <p><span style="color:red"><strong>* Report requires a Behavior Event with a Request for Parent Conference resolution.</strong></span><BR/>
		    <BR/>
	      </p>
	    </TD>
		</TR>
