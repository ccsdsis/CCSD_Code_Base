...
// baseURL
	...
	String srsReportName = "DeanDetentionNotice-BEREDR0003";
	String jspPageName = "DeanDetentionNotice-BEREDR0003";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Detention Notice</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		Print a detention notification for the selected student. <br/><BR/><BR/>
        		  <p><span style="color:red"><strong>*Report requires a Behavior Event with a Detention resolution.</strong></span><BR/>
		</TD>
		</TR>
