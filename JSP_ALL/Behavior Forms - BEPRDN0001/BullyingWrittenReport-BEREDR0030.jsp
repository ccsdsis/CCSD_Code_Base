...
<%
// SIS-5882 2018-04-03 (FM) Include behavior admins with future end date in dropdown list
...
// baseURL
	...
	String srsReportName = "BullyingWrittenReport-BEREDR0030";
	String jspPageName = "BullyingWrittenReport-BEREDR0030";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&personID="+contextID+"&incidentID="+incidentIDValue+"&adminPersonID="+adminPersonIDValue+"&schoolID="+schoolID;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Bullying Written Report</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		Print the Bullying Written Report for the selected student and Bullying behavior event.<br/><BR/><BR/>
		</TD>
		</TR>
 ...
 <%
		    ...
		    SQL2 = "select distinct bh.incidentID " +
					...
					" where bh.personID = " + contextID +
						...
						" and bh.code in (select code from behaviortype where name like '%bully%' and endDate is null and archived = 0) " ;

			result2 = db2.executeQuery(SQL2);


			out.println("<label>Select Bullying Event:</label><br/><select name=IncidentList id=16><option value='NULL' selected='false'> </option>");
			while(result2.next())
...
%>
		<br/>
                ...
                <TR>
                    <td ></br><br>
                      <FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><span class="detailFormColumn" style="padding-top: 0px;">
                      <%
