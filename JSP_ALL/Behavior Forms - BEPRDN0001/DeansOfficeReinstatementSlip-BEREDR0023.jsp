...
// baseURL
	...
	String srsReportName = "DeansOfficeReinstatementSlip-BEREDR0023";
	String jspPageName = "DeansOfficeReinstatementSlip-BEREDR0023";
...
<%
	...
	try
	{
		...
		String timeText1Output = time.replace(" ","%20");
		String timeText1Output2 = timeText1Output.replace("#","%23");
		String timeText1Output3 = timeText1Output2.replace("^", "%5E");
		String timeText1Output4 = timeText1Output3.replace("&", "%26");
		String timeText1Output5 = timeText1Output4.replace("+", "%2B");
		String timeText1Output6 = timeText1Output5.replace(">", "%3E");
		String timeText1Output7 = timeText1Output6.replace("<", "%3C");
		String timeText1Output8 = timeText1Output7.replace("[", "%5B");
		String timeText1Output9 = timeText1Output8.replace("]", "%5D");
		String timeText1Output10 = timeText1Output9.replace("{", "%7B");
		String timeText1Output11 = timeText1Output10.replace("}", "%7D");
		String timeText1Output12 = timeText1Output11.replace("\\", "%5C");
		String timeText1Output13 = timeText1Output12.replace("|", "%7C");
		String timeText1Output14 = timeText1Output13.replace("\"", "%22");
		
		String url = path+dir+srsReportName+"&time="+timeText1Output14+"&personID="+contextID+"&calendarID="+calendarID;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Dean's Office Reinstatement Slip</TD>
		</TR>
		...
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;font-size: 10px; font-weight: bold;" valign="top">
		  <span style="font-size: 8pt">Print a Dean's Office Reinstatement Slip for the selected student.</span>
		  <p></TD>
		</TR>
        ...
        <TR>
          ...
          <p>
            <label for="timeText">Reinstatement Time:</label>
