...
// baseURL
	...
	String srsReportName = "BehaviorContract-BEREDR0025";
	String jspPageName = "BehaviorContract-BEREDR0025";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&schoolID="+schoolID;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Behavior Contract</TD>
		</TR>
		...
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;font-size: 10px; font-weight: bold;" valign="top">
		  <span style="font-size: 8pt">Print a Behavior Contract for the selected student.</span>
		  <p></TD>
		</TR>
