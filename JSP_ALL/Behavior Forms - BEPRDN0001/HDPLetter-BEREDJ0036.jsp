...
<%
// SIS-5877 2018-04-03 (FM) Include behavior admins with future end date in dropdown list
// SIS-3815 2017-02-17 (FM) NEW HDP Letter - English. Pulls resolution code "SUS". 
//
...
// baseURL
	...
	String srsReportName = "HDPLetter-BEREDR0036";
	String jspPageName = "HDPLetter-BEREDJ0036";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;&nbsp;Habitual Discipline Problem (HDP) Letter</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Print a Habitual Discipline Problem (HDP) letter for the selected student and behavior administrator.<br/>
		  </p>
