...
// baseURL
	...
	String srsReportName = "InHouseSuspensionContract-BEREDR0002";
	String jspPageName = "InHouseSuspensionContract-BEREDR0002";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&personID="+contextID+"&calendarID="+calendarID+"&incidentID="+incidentIDValue;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">In-House Suspension Contract</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		Print an In-House Suspension Contract for the selected student. <br/><BR/><BR/>
				  <p><span style="color:red"><strong>*Report requires a Behavior Event with an In House Suspension resolution.</strong></span><BR/></TD>
		</TR>
