...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		...
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Print the Bullying Written Report for the selected student and Bullying behavior event.<br/>
		  </p>
		  <p><span style="color:red"><strong>*Report requires a Behavior Event with a Bullying Behavior Type.</strong></span><BR/>
		    <BR/>
	      </p>
		</TD>
		</TR>
