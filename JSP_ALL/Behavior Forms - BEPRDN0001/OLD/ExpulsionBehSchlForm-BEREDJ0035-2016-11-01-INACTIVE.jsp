...
<%
// SIS-2517 2016-09-30 (FM) New form Expulsion and Behavior School Form. Pulls resolution codes BEH, EXP, HDE and RVT.
...
// baseURL
	...
	String srsReportName = "ExpulsionBehSchlForm-BEREDR0035";
	String jspPageName = "ExpulsionBehSchlForm-BEREDJ0035";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;&nbsp;Expulsion and Behavior School Form CCF-571</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Print an Expulsion and Behavior School Form for the selected student and behavior event.<br/>
		  </p>
		  <p><span style="color:red"><strong>* Report requires a Behavior Event with at least one of the following resolutions:
		     <BR>&nbsp;&nbsp;Behavior School<br>&nbsp;&nbsp;Expulsion<br>&nbsp;&nbsp;Habitual Disciplinary Problem<br>&nbsp;&nbsp;Revoked Trial Enrollment</strong></span><BR/>
		    <BR/>
	      </p>
		</TD>
		</TR>
        ...
        <TR>
		    ...
		    SQL2 = "select distinct bh.incidentID " +
					...
					" where bh.personID = " + contextID +
						...
						" and bh.resolutionCode IN ('BEH', 'EXP', 'HDE', 'RVT') " ;
