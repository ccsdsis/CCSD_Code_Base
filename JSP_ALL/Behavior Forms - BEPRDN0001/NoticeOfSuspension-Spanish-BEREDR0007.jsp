...
// baseURL
	...
	String confDateValue = request.getParameter("confDateText");
	...
	String srsReportName = "NoticeOfSuspension-Spanish-BEREDR0007";
	String jspPageName = "NoticeOfSuspension-Spanish-BEREDR0007";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&calendarID="+calendarID+"&personID="+contextID+"&incidentID="+incidentIDValue+"&prntNotifiedDate="+prntNotifiedDateValue;
		url += "&prntNotifiedTime="+prntNotifiedTimeOutput15+"&confDate="+confDateValue;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;&nbsp;Notice of Suspension (Spanish) CCF-806</TD>
		</TR>
		...
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;font-size: 10px; font-weight: bold;" valign="top">
		  <p><span style="font-weight:bold; font-size:8pt;">Print a Notice of Suspension in Spanish for the selected student and behavior event.</span>
	      </p>
...
%>
                ...
                <p><FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><span class="detailFormColumn" style="padding-top: 10px;">Select Date of Conference (Optional): </br>
                      <input type="text" name="confDateText" id="datepicker2">
                </span></FONT></p></TD>
                <TR>
