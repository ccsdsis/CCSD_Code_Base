...
// baseURL
	...
	String srsReportName = "DisciplineCard-BEREDR0028";
	String jspPageName = "DisciplineCard-BEREDR0028";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Discipline Card</TD>
		</TR>
		...
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;font-size: 10px; font-weight: bold;" valign="top">
		  <span style="font-size: 8pt">Print a Discipline Card for the selected student.</span>
		  <p></TD>
		</TR>
