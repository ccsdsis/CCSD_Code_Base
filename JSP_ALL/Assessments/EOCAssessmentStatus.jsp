...
// baseURL
	...
	String srsReportName = "EOCAssessmentStatus";
	String jspPageName = "EOCAssessmentStatus";
...
<body bgcolor="#E0E0E0" topmargin="4" leftmargin="4">
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;EOC Assessment Status Report</TD>
