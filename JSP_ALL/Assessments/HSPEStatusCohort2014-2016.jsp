<%-- jsp script for "HSPEStatusCohort2014-2016" --%>
<%-- Date written: Oct 15, 2015 --%>
...
// baseURL
	...
	String rValue = request.getParameter("render");
 	...
 	String dir = "HSPETestDataSummary/";	
    String srsReportName = "HSPEStatusCohort2014-2016";
	String jspPageName = "HSPEStatusCohort2014-2016";
...
<body bgcolor="#E0E0E0" topmargin="4" leftmargin="4">
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;HSPE Status Cohort 2014-2016</TD>
		
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
        This report produces the High School Proficiency Test (HSPE) Score data summary for active students based on the given grade levels and the current school/calendar.
                    <span style="color: red;"><strong>HSPE is active for Cohort Year 2014-2016.</strong></span>  		 
		 <br></br> 
		</TD>
		</TR>
      ...
      <table class="style1">
            ...
            <% con.close(); %>
					...
					<tr>
					<td <label style="padding-left: 50px; font-size:small;font-family:arial, helvetica, sans-serif">(Separate multiple grades with comma; Blank for all available Grades)</label></td>
					</tr>
					</td> <br>
            </tr>
         <tr>
