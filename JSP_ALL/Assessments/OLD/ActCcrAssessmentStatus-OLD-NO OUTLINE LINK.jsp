<%-- jsp script for "ACT CCR Assessment Status Report" --%>
...
// baseURL
	...
	String rValue = request.getParameter("render");
 	...
 	String dir = "ActCcrAssessmentStatus/";	
	String srsReportName = "ActCcrAssessmentStatus";
	String jspPageName = "ActCcrAssessmentStatus";
...
<body bgcolor="#E0E0E0" topmargin="4" leftmargin="4">
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;ACT CCR Assessment Status Report</TD>
		
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		 This report produces an ACT College and Career Readiness (CCR) Assessment status report for active students based on the given grade levels and the current school.
		 <br></br> 
		</TD>
		</TR>
