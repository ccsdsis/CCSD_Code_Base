<%-- jsp script for "Credit Attempted and Credit Earned summary Report" --%>
...
// baseURL
    ...
    String srsReportName = "HSPETestDataSummary";
	String jspPageName = "HSPETestDataSummary";
...
<body bgcolor="#E0E0E0" topmargin="4" leftmargin="4">
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;High School Proficiency Test (HSPE) Score Data Summary Report</TD>
