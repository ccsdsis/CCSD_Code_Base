...
// PPS-Expulsion-BEREDJ0043.jsp
// SIS-6348 2018-08-24 (FM) Add " con.close();" to close database connection.
// SIS-4679 2017-12-04 (FM) Rename stored procedure to get school years.  Rename st_CCSD_BehDPPSGetSchYears-BEREDP0004 to st_CCSD_GetSchYears
// SIS-4679 2017-10-26 (FM) New - Custom Report - Behavior>Behavior DPPS>PPS Expulsion List
//                          Input criteria: 
...
// baseURL
	...
	String srsReportName = "PPS-Expulsion-BEREDR0043";
	String jspPageName   = "PPS-Expulsion-BEREDJ0043";
...
<%
	...
	try
	{
		...
		if (request.getParameter("callrspassthru") != null)
		{
			...
			String url = path+dir+srsReportName+"&yearIn="+schYearValue+"&qtrIn="+qtrValue+"&termStartDtIn="+startDateValue+"&termEndDtIn="+endDateValue+"&sortIn="+sortInValue;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp; &nbsp; &nbsp;PPS Expulsion List by Referring School or Student Name</TD>
		</TR>
		
		<TR>
			<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
			This Behavior DPPS report generates a list of PPS Expulsions.</br><br>
			The report can be sorted by student last name/firstname or Referring School Name.<br></br>
			This report is generated in CSV or Excel formats.<br></br>
			</TD>
		</TR>
...
con.close();               //SIS-6348 ADDED THIS LINE
