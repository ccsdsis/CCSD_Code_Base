...
// ExpulsionBrdRatified-BEREDJ0042.jsp
// SIS-4681 2017-10-26 (FM) New - Custom Report - Behavior>Behavior DPPS>Expulsion List Board Ratified
//                          Input criteria: 
//							Board Date (@boardDateIn) populated from Behavior DPPS records where DPPS Close Date >= current date or is null
//							Sort Type: (@sortIn) N=Student last name, firstname, S=school name
//
...
// baseURL
	...
	String srsReportName = "ExpulsionBrdRatified-BEREDR0042";
	String jspPageName   = "ExpulsionBrdRatified-BEREDJ0042";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&boardDateIn="+boardDateValue+"&sortIn="+sortInValue;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp; &nbsp; &nbsp;Expulsion List by School or Student Name - Board Ratified</TD>
		</TR>
		
		<TR>
			<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
			This Behavior DPPS report generates a list of student expulsions that have been ratified by the school board on a specific Board Date</br><br>
			The report can be sorted by student last name/firstname and school name.<br></br>
			</TD>
		</TR>
 ...
 <%
			...
			out.println("<label><br><strong>&nbsp;&nbsp;&nbsp;Select Board Date:</strong></label><br/><select name='boardDateList' id='boardDateList'><option value='' selected='true'></option>");
			while(result1.next())
