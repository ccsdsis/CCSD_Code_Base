...
// BoardRatifyExpulLtrs-BEREDJ0050.jsp
// SIS-6101 2018-06-12 (FM) New - Custom Report - Behavior>Behavior DPPS>Board Ratified Expulsion Letters
...
// baseURL
	...
	String srsReportName = "BoardRatifyExpulLtrs-BEREDR0050";
	String jspPageName   = "BoardRatifyExpulLtrs-BEREDJ0050";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp; &nbsp; &nbsp;Board Ratified Expulsion Letters</TD>
		</TR>
		
		<TR>
			<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
			This Behavior DPPS extract generates a list of students to whom Board Ratified Expulsion Letters will be mailed. </br></br>
			</TD>
		</TR>
