...
// TE-Expulsion-BEREDJ0044.jsp
// SIS-6347 2018-08-24 (FM) Add " con.close();" to close database connection.
// SIS-4680 2017-12-04 (FM) Rename stored procedure to get school years.  Rename st_CCSD_BehDPPSGetSchYears-BEREDP0004 to st_CCSD_GetSchYears
// SIS-4680 2017-10-25 (FM) New - Custom Report - Behavior>Behavior DPPS>Trial Enrollments Expulsion List
//                          Input criteria: 
...
// baseURL
	...
	String srsReportName = "TE-Expulsion-BEREDR0044";
	String jspPageName   = "TE-Expulsion-BEREDJ0044";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp; &nbsp; &nbsp;Trial Enrollments Expulsion List by Referring School or Student Name</TD>
		</TR>
		
		<TR>
			<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
			This Behavior DPPS report generates a list of Trial Enrollments for Expulsion.</br><br>
...
con.close();               //SIS-6347 ADDED THIS LINE
