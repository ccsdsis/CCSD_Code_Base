...
<%
// SIS-5876 2018-04-03 (FM) Include behavior admins with future end date in dropdown list
// variables that already defined because of imports
// appName
// baseURL
// SIS-5329 2017-9-01 (FM) Add " order by exl1.outVal " to session location sql.
	...
	String srsReportName = "SAAPNotificationLetter-Spanish-BEREDR0016";
	String jspPageName = "SAAPNotificationLetter-Spanish-BEREDR0016";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&calendarID="+calendarID+"&adminPersonID="+adminPersonIDValue+"&personID="+contextID+"&sessionDate1="+sessionDate1Value;
		url += "&sessionLocation="+locationText1Output15;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">SAAP Notification Letter (Spanish)</TD>
		</TR>
		    ...
		    SQL1 = "select distinct sf.personID, coalesce(id.firstname, '') + ' ' + coalesce(id.lastname, '') as AdminName " +
					" from [identity] as id with (nolock) " +
						" inner join staffMember as sf with (nolock) on sf.personID = id.personID " +
							...
							" and (sf.endDate is null or sf.endDate >= getdate() ) " +
							" and sf.behavior = 1 " ;
...
%>
          ...
          <input type="text" name="sessionDate1" id="datepicker">
          </span></FONT></p>
          <p><FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><span class="detailFormColumn" style="padding-top: 0px;">
		    ...
		    SQL3 = " select exl1.outVal as locationName " +
					...
					" inner join ccsdextractLookup as exl2 with (nolock) on exl2.ICVal = exl1.ICVal and exl2.fld = 'locationAddress1Spanish' " +
					" inner join ccsdextractLookup as exl3 with (nolock) on exl3.ICVal = exl1.ICVal and exl3.fld = 'locationAddress2Spanish' " +
					...
					" where exl1.fld = 'locationSpanish' " +
					" order by exl1.outVal "  ;

			result3 = db3.executeQuery(SQL3);


			out.println("<label>Select Session Location:</label><br/><select name=sessionLocationList id=18><option value='NULL' selected='false'> </option>");
			while(result3.next())
