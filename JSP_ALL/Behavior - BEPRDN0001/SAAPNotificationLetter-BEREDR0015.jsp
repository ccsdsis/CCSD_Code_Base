...
<%
// SIS-5878 2018-04-03 (FM) Include behavior admins with future end date in dropdown list
// variables that already defined because of imports
// appName
// baseURL
// SIS-5328 2017-09-01 (FM) Add " order by exl1.outVal " to session location sql.
