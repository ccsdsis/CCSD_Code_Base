...
// baseURL
	...
	String srsReportName = "TruantCountsbySchool-BEREDR0031";
	String jspPageName = "TruantCountsbySchool-BEREDR0031";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&endYear="+endYear;
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Truant Counts by School</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>This report produces a list of truant counts by school and a total for the entire district at the top.</p>
