...
// baseURL
	...
	String srsReportName = "MSPromotion_7thGrade";
	String jspPageName = "MSPromotion_7thGrade";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Middle School Promotion Retention Data Report (7th Grade)</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Lists students who have not met 7th grade promotion requirements in Math (MA), English/Reading (LA), Science (SC).</p>
		  <p>&nbsp;</p></TD>
		</TR>
