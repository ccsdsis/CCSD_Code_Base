...
// baseURL
	...
	String srsReportName = "MSPromotion_6thGrade";
	String jspPageName = "MSPromotion_6thGrade";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Middle School Promotion Retention Data Report (6th Grade)</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Lists students who have not met 6th grade promotion requirements in Math (MA6), English/Reading (LA6), Science (SC6).</p>
		  <p>&nbsp;</p></TD>
		</TR>
		...
		<tr>
		<td><p><small>
		  <label style="font-size:small;font-family:arial, helvetica, sans-serif"><strong>Report generates in Microsoft Excel format.</label>
	    &nbsp;</strong></small></p>
		  <p><small> 
