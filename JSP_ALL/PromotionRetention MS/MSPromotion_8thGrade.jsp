...
// baseURL
	...
	String srsReportName = "MSPromotion_8thGrade";
	String jspPageName = "MSPromotion_8thGrade";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">Middle School Promotion Retention Data Report (8th Grade)</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>Lists students who have not met 8th grade promotion requirements in Math (MA), English/Reading (LA), Science (SC).</p>
		  <p>The student's birthdate displays if the student will be 16 years of age by the birthdate cutoff.</p>
		  <p>The student's 7th grade Math &amp; Reading CRT scores if they meet/exceed.</p>
		  <p>The report will indicate if a student is .5 credits short of the total credits required.</p>
		  <p>&nbsp;</p></TD>
		</TR>
		...
		<tr>
		<td><p><small><br>
	    <FONT style="font-family: arial, helvetica, sans; font-size: 8pt; color: #000000; font-weight: normal;"><small><span style="font-size:small;font-family:arial, helvetica, sans-serif"><strong>Report generates in Microsoft Excel format.</span></small></FONT>&nbsp;</strong>
		  <span style="font-size:small;font-family:arial, helvetica, sans-serif"><br>
	    </span></small><small> 
	      <input name="render" type="radio" value="xlsExcel" checked="checked">
	      <span style="font-size:small;font-family:arial, helvetica, sans-serif">Excel</br>
	      </small><br>
      </p>		  </div>  </td></tr>
