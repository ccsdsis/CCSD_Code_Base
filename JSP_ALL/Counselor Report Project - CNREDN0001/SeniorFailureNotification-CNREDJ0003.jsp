...
//SENIOR FAILURE NOTIFICATION - CNREDJ0003.jsp
// variables that already defined because of imports
// appName
// baseURL
// 2018-01-04 SIS-5678 (FM) Remove EOC dates from front-end. Renamed JSP from CNREDR0003.jsp TO CNREDJ0003.jsp.
	...
	String jspPageName = "SeniorFailureNotification-CNREDJ0003";
...
<%
	...
	try
	{
		...
		String url = path+dir+srsReportName+"&schoolID="+schoolID+"&staffPersonID="+personIDValue+"&endYear="+endYear+"&grade="+GradeValue+"&termID="+TermValue;
