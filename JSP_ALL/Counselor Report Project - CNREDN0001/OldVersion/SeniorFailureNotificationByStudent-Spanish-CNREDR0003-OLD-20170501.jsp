...
// baseURL
	...
	String srsReportName = "SeniorFailureNotificationByStudent-Spanish-CNREDR0003";
	String jspPageName = "SeniorFailureNotificationByStudent-Spanish-CNREDR0003";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;Senior Failure Notification by Student (Spanish)</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		The Senior Failure Notification report produces a letter in Spanish for each student selected, who is currently failing one or more courses.<br/><BR/><BR/>
		</TD>
		</TR>
 ...
 <%
			...
			out.println("<label> <strong>Student</strong></label><font color=red size=3> * </font><br/><label>To Select Multiple Students, hold the CTRL button and select students</label><br/><select name=personIDList multiple id=16 style='width:250px; height:300px;'><option value='NULL' selected='true'>Select</option>");
			while(result2.next())
