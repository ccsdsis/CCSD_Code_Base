...
// baseURL
	...
	String dir = "Courses/";
	String srsReportName = "MasterCourse Repeatable COCRD0007";
	String jspPageName = "MasterCourse Repeatable COCRD0007";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		...
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>This report produces a list CourseMaster that are repeatable.</p>
