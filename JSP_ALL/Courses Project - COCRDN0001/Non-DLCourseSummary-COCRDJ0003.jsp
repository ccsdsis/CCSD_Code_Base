...
// baseURL
	...
	String srsReportName ="Non-DLCourseSummary-COCRDR0003";
	String jspPageName = "Non-DLCourseSummary-COCRDJ0003";
...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" width="640">
		<TR>
		<TD class="wizardHeader" width="100%" style="height: 21px;">&nbsp;Non-Distance Learning Courses by School</TD>
		</TR>
		
		<TR>
		<TD class="wizardInstruction" style="padding-top: 10px; padding-right: 30px; padding-left: 30px; height=33px;" valign="top">
		  <p>The Non-Distance Learning Courses by School report provides a listing of course information for each selected school where the course is available by Edgenuity and/or NVLA Canvas.</p><br><br></TD>
		</TR>
